...
class UserServiceTests {
	...
	void testLoadUserByUsername_validUsername() {
		LOGGER.info("START - testLoadUserByUsername_validUsername()");
		...
		LOGGER.info("END - testLoadUserByUsername_validUsername()");
	}
	...
	void testLoadUserByUsername_invalidUsername() {
		LOGGER.info("START - testLoadUserByUsername_invalidUsername()");
		...
		LOGGER.info("END - testLoadUserByUsername_invalidUsername()");
	}
