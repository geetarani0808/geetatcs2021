...
class AuthorizationControllerTests {
	private static final Logger LOGGER = LoggerFactory.getLogger(AuthorizationControllerTests.class);
	...
	void testLogin_withValidCredentials() throws Exception {
		LOGGER.info("START - testLogin_withValidCredentials()");
		...
		LOGGER.info("END - testLogin_withValidCredentials()");
	}
	...
	void testLogin_withGlobalExceptions() throws Exception {
		LOGGER.info("START - testLogin_withGlobalExceptions()");
		...
		LOGGER.info("END - testLogin_withGlobalExceptions()");
	}
	...
	void testLogin_withInvalidCredentials() throws Exception {
		LOGGER.info("START - testLogin_withInvalidCredentials()");
		...
		LOGGER.info("END - testLogin_withInvalidCredentials()");
	}
	...
	void testLogin_withLockedCredentials() throws Exception {
		LOGGER.info("START - testLogin_withLockedCredentials()");
		...
		LOGGER.info("END - testLogin_withLockedCredentials()");
	}
	...
	void testLogin_withDisabledAccountCredentials() throws Exception {
		LOGGER.info("START - testLogin_withDisabledAccountCredentials()");
		...
		LOGGER.info("END - testLogin_withDisabledAccountCredentials()");
	}
	...
	void testValidateAdmin_withValidTokenAndRole() throws Exception {
		LOGGER.info("START - testValidateAdmin_withValidTokenAndRole()");
		...
		LOGGER.info("END - testValidateAdmin_withValidTokenAndRole()");
	}
	...
	void testValidate_withInvalidToken() throws Exception {
		LOGGER.info("START - testValidate_withInvalidToken()");
		...
		LOGGER.info("END - testValidate_withInvalidToken()");
	}
	...
	void testValidate_withInvalidRole() throws Exception {
		LOGGER.info("START - testValidate_withInvalidRole()");
		...
		LOGGER.info("END - testValidate_withInvalidRole()");
	}
	...
	void testStatusCheck() throws Exception {
		LOGGER.info("START - testStatusCheck()");
		...
		LOGGER.info("END - testStatusCheck()");
	}
